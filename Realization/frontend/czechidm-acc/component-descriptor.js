  ...
  components: [
    ...
    },
    {
      ...
      entityType: [
        ...
        "SysRemoteServer",
        "SysRemoteServerDto",
        "SysConnectorServerDto",
        "SysConnectorServer",
      ],
      component: require("./src/components/RemoteServerInfo/RemoteServerInfo")
        .default,
    ...
    },
    {
      ...
      component:
        require("./src/components/SchemaAttributeInfo/SchemaAttributeInfo")
          .default,
    ...
    },
    {
      ...
      component:
        require("./src/components/SystemAttributeMappingInfo/SystemAttributeMappingInfo")
          .default,
    ...
    },
    {
      ...
      component: require("./src/components/SystemMappingInfo/SystemMappingInfo")
        .default,
    ...
    },
    {
      ...
      entityType: [
        "syncConfig",
        "SysSyncIdentityConfig",
        "SysSyncIdentityConfigDto",
        "SysSyncConfig",
        "SysSyncConfigDto",
        "SysSyncContractConfig",
        "SysSyncContractConfigDto",
      ],
      component: require("./src/components/SyncConfigInfo/SyncConfigInfo")
        .default,
    ...
    },
    {
      ...
      entityType: [
        ...
        "SysProvisioningBreakConfig",
        "SysProvisioningBreakConfigDto",
      ],
      component: require("./src/components/BreakConfigInfo/BreakConfigInfo")
        .default,
    ...
    },
    {
      ...
      type: "entity-info",
      entityType: [
        "provisioningBreakRecipient",
        "SysProvisioningBreakRecipient",
        "SysProvisioningBreakRecipientDto",
      ],
      component:
        require("./src/components/BreakConfigRecipientInfo/BreakConfigRecipientInfo")
          .default,
    ...
    },
    {
      ...
      component: require("czechidm-core/src/components/advanced/Form/SelectBoxFormAttributeRenderer"),
      labelKey:
        "acc:component.advanced.EavForm.faceType.SYNCHRONIZATION-CONFIG-SELECT",
      manager: require("./src/redux").SynchronizationConfigManager,
    },
    {
      ...
      labelKey:
        "acc:component.advanced.EavForm.faceType.SYSTEM-MAPPING-ATTRIBUTE-FILTERED-SELECT",
      manager: require("./src/redux").SystemAttributeMappingManager,
    },
    {
    ...
    },
    {
      ...
      component:
        require("czechidm-core/src/components/advanced/FormValueInfo/FormValueInfo")
          .default,
    },
    {
      ...
      component:
        require("./src/content/monitoring/button/SynchronizationMonitoringResultButton")
          .default,
    },
    {
      ...
      component:
        require("./src/content/monitoring/button/ProvisioningOperationMonitoringResultButton")
          .default,
    },
    {
      ...
      component:
        require("./src/components/SystemUniversalSearchType/SystemUniversalSearchType")
          .default,
    },
  ],
};
