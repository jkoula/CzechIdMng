  ...
  navigation: {
    items: [
        ...
        items: [
          {
            ...
            icon: "component:systems",
            access: [
              { type: "HAS_ANY_AUTHORITY", authorities: ["SYSTEM_READ"] },
            ],
            items: [
              {
                id: "system-detail",
              ...
              },
              {
                ...
                labelKey:
                  "acc:content.system.systemSynchronizationConfigs.title",
                order: 60,
          ...
          },
          {
            ...
            access: [
              {
                type: "HAS_ANY_AUTHORITY",
                authorities: ["UNIFORMPASSWORD_READ"],
              },
            ],
            items: [
              {
      ...
      },
      {
        ...
        icon: "fa:external-link",
        access: [
          { type: "HAS_ANY_AUTHORITY", authorities: ["IDENTITYACCOUNT_READ"] },
        ],
      },
      {
      ...
      },
      {
        ...
        icon: "fa:external-link",
        access: [
          { type: "HAS_ANY_AUTHORITY", authorities: ["CONTRACTACCOUNT_READ"] },
        ],
      },
      {
      ...
      },
      {
        ...
        icon: "fa:external-link",
        access: [
          { type: "HAS_ANY_AUTHORITY", authorities: ["TREEACCOUNT_READ"] },
        ],
      },
      {
