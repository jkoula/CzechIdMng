module.exports = {
  ...
  childRoutes: [
    ...
    },
    {
      ...
      childRoutes: [
        ...
        },
        {
          ...
          access: [
            {
              type: "HAS_ALL_AUTHORITIES",
              authorities: ["SYSTEM_READ", "ACCOUNT_READ"],
            },
          ],
        },
        {
        ...
        },
        {
          ...
          component: require("./src/content/system/SchemaObjectClassDetail"),
          access: [
            { type: "HAS_ANY_AUTHORITY", authorities: ["SYSTEM_UPDATE"] },
          ],
        },
        {
          ...
          access: [
            {
              ...
              authorities: [
                "PROVISIONINGOPERATION_READ",
                "PROVISIONINGARCHIVE_READ",
              ],
            },
          ],
        },
        ...
        },
        {
          ...
          access: [
            { type: "HAS_ANY_AUTHORITY", authorities: ["SYSTEM_CREATE"] },
          ],
        },
        {
        ...
        },
        {
          ...
          access: [
            {
              type: "HAS_ANY_AUTHORITY",
              authorities: ["SYSTEM_UPDATE", "SYSTEM_READ"],
            },
          ],
        },
        {
          ...
          access: [
            {
              type: "HAS_ANY_AUTHORITY",
              authorities: ["ROLE_READ", "SYSTEM_READ"],
            },
          ],
        },
        {
    ...
    },
    {
      ...
      access: [
        { type: "HAS_ANY_AUTHORITY", authorities: ["REMOTESERVER_READ"] },
      ],
    },
    {
      ...
      childRoutes: [
        ...
        },
        {
          ...
          access: [
            {
              type: "HAS_ALL_AUTHORITIES",
              authorities: ["REMOTESERVER_READ", "SYSTEM_READ"],
            },
          ],
        },
        {
          ...
          access: [
            { type: "HAS_ALL_AUTHORITIES", authorities: ["REMOTESERVER_READ"] },
          ],
        },
      ],
    },
      ...
      childRoutes: [
        {
          ...
          access: [
            {
              type: "HAS_ANY_AUTHORITY",
              authorities: ["IDENTITYACCOUNT_READ"],
            },
          ],
        },
        {
      ...
      childRoutes: [
        {
          ...
          access: [
            {
              type: "HAS_ANY_AUTHORITY",
              authorities: ["CONTRACTACCOUNT_READ"],
            },
          ],
        },
      ],
      ...
      childRoutes: [
        {
          ...
          access: [
            {
              type: "HAS_ANY_AUTHORITY",
              authorities: ["CONTRACTSLICEACCOUNT_READ"],
            },
          ],
        },
      ],
    },
    {
      ...
      access: [
        { type: "HAS_ANY_AUTHORITY", authorities: ["PASSWORDPOLICY_READ"] },
      ],
      childRoutes: [
        {
          ...
          access: [
            {
              type: "HAS_ALL_AUTHORITIES",
              authorities: ["PASSWORDPOLICY_READ", "SYSTEM_READ"],
            },
          ],
        },
      ],
      ...
      childRoutes: [
        {
          ...
          access: [
            { type: "HAS_ANY_AUTHORITY", authorities: ["ROLEACCOUNT_READ"] },
          ],
        },
        {
          path: "systems",
      ...
      childRoutes: [
        {
          ...
          access: [
            { type: "HAS_ANY_AUTHORITY", authorities: ["TREENODE_READ"] },
          ],
          childRoutes: [
            {
              path: "accounts",
    ...
    },
    {
      ...
      access: [
        { type: "HAS_ANY_AUTHORITY", authorities: ["ROLECATALOGUE_READ"] },
      ],
      childRoutes: [
        {
          path: "accounts",
          ...
          access: [
            {
              type: "HAS_ANY_AUTHORITY",
              authorities: ["ROLECATALOGUEACCOUNT_READ"],
            },
          ],
        },
      ],
    ...
    },
    {
      ...
      access: [
        { type: "HAS_ANY_AUTHORITY", authorities: ["PASSWORDFILTER_READ"] },
      ],
    },
    {
    ...
    },
    {
      ...
      access: [
        { type: "HAS_ANY_AUTHORITY", authorities: ["SYSTEM_GROUP_CREATE"] },
      ],
    },
    {
      path: "system-groups",
      ...
      access: [
        { type: "HAS_ANY_AUTHORITY", authorities: ["SYSTEM_GROUP_READ"] },
      ],
    },
    {
