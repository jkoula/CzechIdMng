...
export class ScriptArea extends AbstractFormComponent {
  ...
  initCompleters() {
    ...
    if (component) {
      ...
      const originalCompleters = editor.completers
        ...
        .filter(
          (completer) =>
            !completer.hasOwnProperty("isCustomCompleter") ||
            !completer.isCustomCompleter()
        );
  ...
  _getAceEditor(AceEditor, mode, className, height, modal = false) {
    return (
      <AceEditor
        ...
        className={className}
        title={
          this.getValidationResult() != null
            ? this.getValidationResult().message
            : ""
        }
  ...
  _getComponent(feedback) {
    ...
    const AceEditorInstance = this._getAceEditor(
      AceEditor,
      mode,
      className,
      height,
    ...
    return (
      ...
      >
        ...
        <div className={componentSpan}>
          <Tooltip
            ref="popover"
            placement={this.getTitlePlacement()}
            value={this.getTitle()}
          >
            <span>
              ...
              >
                ...
                <Modal.Footer>
                  <Button
                    level="link"
                    onClick={this._closeModalEditor.bind(this)}
                  >
