...
import eu.bcvsolutions.idm.core.model.service.impl.AbstractIdmRoleFormAttributeServiceIntegrationTest;

/**
 * Basic role form attribute service test for account roles.
 * 
 * @author Tomáš Doischer
 *
 */
public class DefaultAccountRoleFormAttributeServiceIntegrationTest extends AbstractIdmRoleFormAttributeServiceIntegrationTest {
	...
	public AbstractConceptRoleRequestDto createConceptRoleRequest(IdmRoleRequestDto request, IdmRoleDto role, UUID assigneeId,
		...
		return helper.createAccountConceptRoleRequest(request.getId(), role.getId(), assigneeId, roleAssignmentId, operationType, validFrom, null);
	}
