...
public class AccountManagementBulkActionTest extends AbstractBulkActionTest {
...
//		assertTrue(!isEmptyProvisioning(operations.get(0), true));
		...
		assertEquals(1, operations.size());
		assertTrue(isEmptyProvisioning(operations.get(0), false));
		// TODO
	}
	
	private boolean isEmptyProvisioning(SysProvisioningOperationDto provisioningOperation, boolean create) {
		return create || (provisioningOperation.getProvisioningContext() != null && provisioningOperation.getProvisioningContext().getConnectorObject() != null
