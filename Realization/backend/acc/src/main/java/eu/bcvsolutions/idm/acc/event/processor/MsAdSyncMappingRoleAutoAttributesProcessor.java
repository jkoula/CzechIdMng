...
public class MsAdSyncMappingRoleAutoAttributesProcessor extends MsAdMappingIdentityAutoAttributesProcessor {
	...
	public static final String RESOLVE_ROLE_CATALOG_BY_DN_SCRIPT = "resolveRoleCatalogueByDn";
	public static final String RESOLVE_ROLE_CATALOG_UNDER_MAIN_SCRIPT = "resolveRoleCatalogueUnderMainCatalogue";
