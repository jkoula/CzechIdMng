...
public interface BaseFaceType {
	...
	String IDENTITY_READ_SELECT = "IDENTITY-READ-SELECT"; // @since 11.2.0 - read permission is needed
	...
	String READ_DTO_SERVICE_SELECT = "READ-DTO-SERVICE-SELECT"; // @since 11.1.0 
	//
