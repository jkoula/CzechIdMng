 ...
 */
@Transactional
public abstract class AbstractIdmIncompatibleRoleServiceIntegrationTest extends AbstractIntegrationTest {
...
//						role.getId(), "rights", "return [\"value-" + i +"\"]", IcObjectClassInfo.ACCOUNT);
		...
		for (IdmRoleDto assignRole : assignRoles) {
			createConceptRoleRequest(roleRequest, assignRole, owner.getId(), ConceptRoleRequestOperation.ADD);
		}
