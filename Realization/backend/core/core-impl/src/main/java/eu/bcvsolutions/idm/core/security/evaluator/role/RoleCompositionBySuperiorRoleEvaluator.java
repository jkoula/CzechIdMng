...
/**
 * Permissions to business roles by superior role.
 * 
 * @author Radek Tomiška
 * @since 9.0.0
 */
@Component(RoleCompositionBySuperiorRoleEvaluator.EVALUATOR_NAME)
@Description("Permissions to business roles by superior role.")
public class RoleCompositionBySuperiorRoleEvaluator extends AbstractTransitiveEvaluator<IdmRoleComposition> {

	public static final String EVALUATOR_NAME = "core-role-composition-by-superior-role-evaluator";
	...
	@Override
	public Predicate getPredicate(Root<IdmRoleComposition> root, CriteriaQuery<?> query, CriteriaBuilder builder, AuthorizationPolicy policy, BasePermission... permission) {
		...
		subquery.where(builder.and(
				...
				builder.equal(root.get(IdmRoleComposition_.superior), subRoot) // correlation attribute
				));
		//
	...
	@Override
	public Set<String> getPermissions(IdmRoleComposition entity, AuthorizationPolicy policy) {
