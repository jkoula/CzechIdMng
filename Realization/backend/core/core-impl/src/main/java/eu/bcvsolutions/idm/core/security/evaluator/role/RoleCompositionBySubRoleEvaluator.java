...
public class RoleCompositionBySubRoleEvaluator extends AbstractTransitiveEvaluator<IdmRoleComposition> {

	public static final String EVALUATOR_NAME = "core-role-composition-by-sub-role-evaluator";
	...
	public Predicate getPredicate(Root<IdmRoleComposition> root, CriteriaQuery<?> query, CriteriaBuilder builder, AuthorizationPolicy policy, BasePermission... permission) {
		...
		subquery.where(builder.and(
				...
				builder.equal(root.get(IdmRoleComposition_.sub), subRoot) // correlation attribute
				));
		//
