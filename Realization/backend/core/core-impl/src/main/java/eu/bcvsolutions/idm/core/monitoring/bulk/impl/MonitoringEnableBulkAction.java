...
/**
 * Enable monitoring evaluator.
 * 
 * @author Radek Tomiška
 * @since 11.1.0
 */
@Component(MonitoringEnableBulkAction.NAME)
@Description("Enable monitoring evaluator.")
public class MonitoringEnableBulkAction extends AbstractBulkAction<IdmMonitoringDto, IdmMonitoringFilter> {

	public static final String NAME = "core-monitoring-enable-bulk-action";
	//
	@Autowired private IdmMonitoringService service;
	
	@Override
	public String getName() {
		return MonitoringEnableBulkAction.NAME;
	}
