 ...
 */
public class IdentityRoleConceptCompilingAdapter implements DtoAdapter<IdmIdentityRoleDto, IdmRequestIdentityRoleDto> {

    private final IdmRequestIdentityRoleFilter originalFilter;
    private final BasePermission permission;

    private final IdmConceptRoleRequestService conceptService;
    ...
    @Override
    public Stream<IdmRequestIdentityRoleDto> transform(Stream<IdmIdentityRoleDto> input) {
        final List<IdmIdentityRoleDto> inputRoles = input.collect(Collectors.toList());
    ...
    private void compileIdentityRolesWithConcepts(List<IdmRequestIdentityRoleDto> requestIdentityRoles,
        ...
        IdmConceptRoleRequestFilter conceptFilter = conceptService.getFilter();
        conceptFilter.setRoleAssignmentUuids(identityRoleIds);
        conceptFilter.setRoleRequestId(filter.getRoleRequestId());

        List<IdmConceptRoleRequestDto> conceptsForThisPage = conceptService.find(conceptFilter, null, permission).getContent();
    ...
    private boolean getIdmRequestIdentityRoleDtoPredicate(IdmConceptRoleRequestDto concept, IdmRequestIdentityRoleDto idmRequestIdentityRoleDto) {
        return idmRequestIdentityRoleDto.getRoleAssignmentUuid() != null &&
                idmRequestIdentityRoleDto.getRoleAssignmentUuid().equals(concept.getIdentityRole()) &&
                idmRequestIdentityRoleDto.getId().equals(concept.getIdentityRole());
    }
     ...
     */
    private void addEav(IdmIdentityRoleDto identityRole, IdmRequestIdentityRoleDto result, IdmFormInstanceDto formInstanceDto) {
        if (formInstanceDto != null) {
            ...
            List<InvalidFormAttributeDto> validationResults = identityRoleService.validateFormAttributes(identityRole);
    ...
    private void addEav(IdmConceptRoleRequestDto concept, IdmRequestIdentityRoleDto requestIdentityRoleWithConcept, IdmFormInstanceDto formInstanceDto) {
        if (formInstanceDto != null) {
