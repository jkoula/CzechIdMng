...
/**
 * Permissions to incompatible roles by superior role.
 * 
 * @author Radek Tomiška
 * @since 9.4.0
 */
@Component(IncompatibleRoleBySuperiorRoleEvaluator.EVALUATOR_NAME)
@Description("Permissions to incompatible roles by superior role.")
public class IncompatibleRoleBySuperiorRoleEvaluator extends AbstractTransitiveEvaluator<IdmIncompatibleRole> {

	public static final String EVALUATOR_NAME = "core-incompatible-role-by-superior-role-evaluator";
	...
	@Override
	public Predicate getPredicate(Root<IdmIncompatibleRole> root, CriteriaQuery<?> query, CriteriaBuilder builder, AuthorizationPolicy policy, BasePermission... permission) {
		...
		subquery.where(builder.and(
				...
				builder.equal(root.get(IdmIncompatibleRole_.superior), subRoot) // correlation attribute
				));
		//
	...
	@Override
	public Set<String> getPermissions(IdmIncompatibleRole entity, AuthorizationPolicy policy) {
